    ...
    <div class="col-12">
        ...
        <div id="print-area" class="bill p-3 mb-3 card card-{{$badge}} card-outline">
            ...
            <div class="row no-print">
                <div class="col-12">
                    <a href="#" data-href="{{ route('bill.destroy', $bill) }}" class="btn btn-outline-danger btn-lg float-right btn-lg" data-toggle="modal" data-target="#myModal">
                        <i class="fa fa-trash ambitious-padding-btn"></i> Delete
                    </a>

                    <a class="btn btn-outline-warning btn-lg float-right" style="margin-right: 5px;" href="{{ route('bill.index') }}">
                        <i class="fas fa-ban"></i> Cancel
                    </a>

                    @if ($bill->bill_status_code != 'paid')
                        <a class="btn btn-lg btn-outline-success" id="addPaymentModel" i_id="{{$bill->id}}" href="javascript:void(0)"> <i class="fas fa-money-check-alt mr-2"></i>Add Payment</a>
                    @endif
