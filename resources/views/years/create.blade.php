...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('scholarship-year.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-8">
                              ...
                              <div class="form-group input-group mb-3">
                                  ...
                                  <input type="number" name="name" value="{{ old('name') }}" class="form-control" placeholder="@lang('Enter Year Name')" required>
                              </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('scholarship-year.index') }}" class="btn btn-outline btn-warning btn-lg" style="float:right">@lang('Cancel')</a>
                        </div>
                    </div>
                </form>
            </div>
