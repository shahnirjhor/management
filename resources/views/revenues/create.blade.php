        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Add Revenue')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('Add Revenue')</h3>
            </div>
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('revenue.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" name="paid_at" id="paid_at" class="form-control flatpickr" value="{{ old('paid_at') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <input id="currency_code" name="currency_code" type="hidden" value="{{ $account_currency_code }}" required>
                    <input id="currency_rate" name="currency_rate" type="hidden" value="{{ $currency->rate }}" required>
                    <div class="form-group">
