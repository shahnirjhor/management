        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Create Vendor')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>@lang('Create Vendor')</h3>
            </div>
            <div class="card-body">
                <form id="customerQuickForm" class="form-material form-horizontal" action="{{ route('vendor.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
