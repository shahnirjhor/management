                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control ambitious-form-loading @error('scholarship_village_id') is-invalid @enderror" name="scholarship_village_id" value="{{ old('scholarship_village_id') }}" id="scholarship_village_id" type="text" placeholder="{{ __('Type Provider Organization Name Here') }}" required>
